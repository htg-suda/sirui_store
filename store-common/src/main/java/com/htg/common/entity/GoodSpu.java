...
public class GoodSpu extends BaseEntity {
    ...
    @TableField("general_spec_value_snapshot")
    ...
    public GoodSpu setGeneralSpecValueSnapshot(String generalSpecValueSnapshot) {
    ...
    public String toString() {
        ...
        ", generalSpecValueSnapshot=" + generalSpecValueSnapshot +
        ", freight=" + freight +
        ", state=" + state +
